      ...
      <div className="bg-white p-6 md:p-14 rounded-[2rem] md:rounded-[4rem] shadow-2xl w-full max-w-2xl border-[8px] md:border-[12px] border-yellow-400 relative overflow-hidden">
        ...
        {mode === 'giliran' ? (
          ...
          <div className="mb-8 md:mb-14 p-6 md:p-12 bg-purple-50 rounded-[2rem] md:rounded-[3rem] border-[6px] border-purple-200 shadow-inner relative z-10">
            <p className="text-purple-400 font-black uppercase tracking-widest mb-4 md:mb-6 text-lg md:text-2xl">Bintang Kelas Kita</p>
            ...
            <p className="text-xl md:text-2xl text-purple-600 mt-5 md:mt-8 font-black bg-white inline-block px-6 md:px-8 py-3 md:py-4 rounded-3xl shadow-md border-4 border-purple-100">Kelas yang luar biasa!</p>
          </div>
        )}
